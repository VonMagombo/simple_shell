 ...
 */
list_t *add_node(list_t **head_ptr, char *str, int num)
{
	list_t *new_node;
...
/**
 * last_node_add - adds a node to the end of the list
 ...
 * Return: size of list
 */
list_t *last_node_add(list_t **head, const char *str, int num)
{
